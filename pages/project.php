        ...
        <div class="card border-0">
          <table class="table table-success table-striped table-hover mt-5">
            ...
            <tbody class="fs-22">
              ...
              <tr>
                <td>ประกาศผลโครงงานที่ผ่านรอบคัดเลือก รอบสุดท้าย</td>
                <td>ภายใน วันที่ <span class="redmidline">17 เมษายน 2567</span>
                  <span class="red"> 30 เมษายน 2567</span>
                </td>
              </tr>
              <tr>
                <td>ผู้ผ่านเข้ารอบสุดท้ายส่งไฟล์นำเสนอและรูปเล่มโครงงานฉบับเต็ม</td>
                <td>ภายใน วันที่ 2 มิถุนายน 2567</td>
              </tr>
              <tr>
        ...
        <div class="card border-0" style="color: #494949;">
          ...
          <ul class="unlist">
            <li>Abstract Template for Physics Project 2024
              <button class="btn btn-warning" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">Download
                File</button>
            </li>
          ...
          <ul class="unlist">
            <li>ประกาศหลักเกณฑ์การสนับสนุนค่าใช้จ่าย >>
              <a style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;" href="/file/download/project-announce.pdf"
                class="btn btn-warning" target="_blank">Download File</a>
            </li>
            <li>แนวปฏิบัติสำหรับการเข้าประกวด >>
              <a style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;" href="/file/download/project-guild.pdf"
                class="btn btn-warning" target="_blank">Download File</a>
            </li>
          </ul>
          <ul class="unlist">
            <li>ไฟล์รายงานโครงงานอิสระฉบับสมบูรณ์ ส่งได้ที่ >> <a style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;"
                href="https://forms.gle/yvfuMJ89p9BGNP6j9" class="btn btn-warning" target="_blank">Link</a>
            </li>
        ...
        <div class="card border-0" style="color: #494949;">
          <div class="table-responsive">
            <table class="table table-success table-striped table-hover mt-3">
              ...
              <tbody class="fs-18">
                <tr>
                  <td style="text-align: center;">รางวัลชนะเลิศ</td>
                  <td style="text-align: center;">นายพลเศรษฐ ฉึ่น ธีรศาสตร์</td>
                  <td style="text-align: center;">มหาวิทยาลัยขอนแก่น</td>
                  <td>การเพิ่มประสิทธิภาพการสังเคราะห์ด้วยแสงในต้นข้าวด้วย คาร์บอนควอนตัมดอท<br>(Boosting Photosynthesis in
                    Rice with Carbon Quantum Dots)</td>
                </tr>
                <tr>
                  <td style="text-align: center;">รางวัลรองชนะเลิศอันดับ 1</td>
                  <td style="text-align: center;">นายวรพล เจนพาณิชย์วงศ์</td>
                  <td style="text-align: center;">มหาวิทยาลัยมหิดล</td>
                  <td>พลศาสตร์ของสปินของคิวบิทแบบโมเลกุลที่อุณหภูมิห้องด้วยการคำนวณแบบ<br>(ab initio
                    Ab Initio Investigation for Spin Coherence Dynamics of the Molecular Qubits at Room
                    Temperature)
                  </td>
                </tr>
                <tr>
                  <td style="text-align: center;">รางวัลรองชนะเลิศอันดับ 2</td>
                  <td style="text-align: center;">นายสุภกิจ ชินภักดี</td>
                  <td style="text-align: center;">มหาวิทยาลัยเกษตรศาสตร์</td>
                  <td>ลูกบอลเตือนภัย: การตรวจจับก๊าซอันตรายผ่านการโยน<br>(Safety Alert Smart ball: Detecting Hazardous Gas
                    through Tossing)</td>
                </tr>
                <tr>
                  <td style="text-align: center;">รางวัลประกาศเกียรติคุณ</td>
                  <td style="text-align: center;">นายทศนัท ริมโพธิ์เงิน</td>
                  <td style="text-align: center;">มหาวิทยาลัยมหิดล</td>
                  <td>การพัฒนาชุดเครื่องมือสาธิตการกระจายกุญแจรหัสทางควอนตัมที่ใช้หลักการโพลาไรเซชันของแสง<br>(Development
                    of polarization-based demonstration kits for Quantum key distribution)</td>
                </tr>
                <tr>
                  <td style="text-align: center;">รางวัลประกาศเกียรติคุณ</td>
                  <td style="text-align: center;">นางสาวมัชฌิมา วังพิมูล</td>
                  <td style="text-align: center;">มหาวิทยาลัยขอนแก่น</td>
                  <td>
                    การพัฒนาสื่อการเรียนการสอนโดยใช้แบบจําลองการตรวจจับดาวเคราะห์นอกระบบสุริยะด้วยวิธีการเคลื่อนที่ผ่านหน้า<br>
                    (The development of teaching and learning apparatus based on the simulation of exoplanet
                    detection by the transit method)</td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            <table class="table table-success table-striped table-hover mt-3">
              ...
              <tbody class="fs-18">
                ...
                <tr>
                  ...
                  <td style="text-align: center;">มหาวิทยาลัยธรรมศาสตร์</td>
                ...
                <tr>
                  ...
                  <td style="text-align: center;">มหาวิทยาลัยมหิดล</td>
                  <td>การพัฒนาชุดเครื่องมือสาธิตการกระจายกุญแจรหัสทางควอนตัมที่ใช้หลักการโพลาไรเซชันของแสง/Development
                    of
                    polarizationbased demonstration kits for Quantum key distribution</td>
                </tr>
                <tr>
                  <td style="text-align: center;">4</td>
                  <td style="text-align: center;">พรพิพัฒน์ เพ็ชรพงษ์ </td>
                  <td style="text-align: center;">มหาวิทยาลัยราชภัฏพิบูลสงคราม</td>
                ...
                <tr>
                  ...
                  <td>การออกแบบและประมาณค่าสมรรถนะเบื้องต้นของกล้องโทรทรรศน์ 0.8 เมตร แบบริชชี่ เครเทียน
                    สำหรับหอดูดาวภูมิภาค สถาบันวิจัยดาราศาสตร์แห่งชาติ / Preliminary design and performance estimation
                    of
